...
const inputVariants = cva(
  ...
  `,
  {
    variants: {
      variant: {
        lg: 'py-1 min-h-10 px-4 text-sm rounded-xl [&~[data-slot=combobox-icon]]:end-2.5 [&~[data-slot=combobox-clear]]:end-7',
        md: 'py-1 min-h-9 px-3 text-sm rounded-xl [&~[data-slot=combobox-icon]]:end-2 [&~[data-slot=combobox-clear]]:end-6',
        sm: 'py-0.5 min-h-8 px-2.5 text-xs rounded-xl [&~[data-slot=combobox-icon]]:end-1.75 [&~[data-slot=combobox-clear]]:end-5.75',
      },
    },
    defaultVariants: {
      variant: 'md',
  ...
  return (
    <ComboboxPrimitive.Popup
      ...
      className={cn(
        ...
        'rounded-xl border border-border bg-popover text-popover-foreground shadow-md shadow-black/5',
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        ...
        'text-foreground relative select-none items-center gap-2 rounded-xl ps-7 pe-2 py-1.5 text-sm outline-hidden transition-colors data-disabled:pointer-events-none data-disabled:opacity-50',
...
function ComboboxChip({ className, ...props }: React.ComponentProps<typeof ComboboxPrimitive.Chip>) {
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        'inline-flex items-center gap-1 rounded-xl bg-muted px-2 py-1 text-xs font-medium text-foreground',
        className,
      )}
      {...props}
    />
