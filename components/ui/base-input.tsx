...
const inputVariants = cva(
  ...
  `,
  {
    variants: {
      variant: {
        lg: 'h-10 px-4 text-sm rounded-xl file:pe-4 file:me-4',
        md: 'h-9 px-3 text-sm rounded-xl file:pe-3 file:me-3',
        sm: 'h-8 px-2.5 text-xs rounded-xl file:pe-2.5 file:me-2.5',
      },
    },
    defaultVariants: {
      variant: 'md',
...
const inputAddonVariants = cva(
  'flex items-center shrink-0 justify-center bg-muted border border-input shadow-xs shadow-[rgba(0,0,0,0.05)] text-secondary-foreground [&_svg]:text-secondary-foreground/60',
  {
    variants: {
      variant: {
        lg: 'rounded-xl h-10 min-w-10 px-4 text-sm [&_svg:not([class*=size-])]:size-4.5',
        md: 'rounded-xl h-9 min-w-9 px-3 text-sm [&_svg:not([class*=size-])]:size-4.5',
        sm: 'rounded-xl h-8 min-w-7 text-xs px-2.5 [&_svg:not([class*=size-])]:size-3.5',
      },
      mode: {
        default: '',
